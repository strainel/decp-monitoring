...
labels <- c('aife' = "Aife / DUME", 'pes' = "DGFiP / PES marchés", 'emarchespublics' = "e-MarchésPublics",
            'grandlyon' = "Grand Lyon", 'marchespublicsinfo' = "MarchésPublics.info", 'atexomaximilien'="Atexo-Maximilien", 'ternumbfc' ="Ternum-BFC", 'megalisbretagne'="Megalis-Bretagne")
...
plot_ly(stats_cumul, x= ~date, y= ~aife, mode= 'lines', type='scatter', name = labels['aife'], 
  ...
  add_trace(y= ~atexomaximilien, name = labels['atexomaximilien']) %>%
  add_trace(y= ~ternumbfc, name = labels['ternumbfc']) %>%
  add_trace(y= ~megalisbretagne, name = labels['megalisbretagne']) %>%
