...
Ce tableau de bord permet de suivre le processus de construction du fichier consolidé des données essentielles de la commande publique. En effet, chaque jour, des nouvelles données sont publiées par des éditeurs ou des portails acheteurs. Elles sont consolidées en un seul fichier et mises à disposition tous les matins (vers 9h) en *opendata* sur le site  [data.gouv.fr](https://www.data.gouv.fr/fr/datasets/donnees-essentielles-de-la-commande-publique-fichiers-consolides/).
